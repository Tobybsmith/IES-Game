...
handblue = spritesheet("hand_r_blu.png", 4, 5)
handred = spritesheet("hand_r_red.png", 4, 5)
...
rocketblue = spritesheet("rocket_blu.png", 2, 3)
rocketred = spritesheet("rocket_red.png", 2, 3)
mortar = spritesheet("mortar.png", 2, 3)
bullet = spritesheet("bullet.png", 1, 1)
...
while running:
        ...
        if shootingwep1 == 2: #sniper rifle
            ...
            if wepphase1 == 1:
                ...
                if framecount1 == 5:
                    if play1lr == "r":
                        sniperx1 = play1x + 45
                        pygame.draw.rect(screen, snipershot, (sniperx1, snipery1, 1360 - sniperx1, 2), 0)
                        for numb in range(sniperx1, 1360):
        ...
        if shootingwep2 == 2: #sniper rifle
            ...
            if wepphase2 == 1:
                ...
                if framecount2 == 5:
                    if play2lr == "r":
                        sniperx2 = play2x + 45
                        pygame.draw.rect(screen, snipershot, (sniperx2, snipery2, 1360 - sniperx2, 2), 0)
                        for numb in range(sniperx2, 1360):
    ...
    if mortarshot1 == True:
        ...
        if mortarx1 <= 0 or mortarx1 >= 1360:
            mortarshot1 = False
    ...
    if mortarshot2 == True:
        ...
        if mortarx2 <= 0 or mortarx2 >= 1360:
            mortarshot2 = False
        if mortary2 >= ground[mortarx2]:
            mortarshot2 = False
            mortarexploded2 = True
            mortarexplodeframe2 = 1
    ...
    #player 2 health bar
    pygame.draw.rect(screen, barout, (1340, 20, -110, 35), 0)
    pygame.draw.rect(screen, barback, (1335, 25, -100, 25), 0)
    if play2health >= 1:
        pygame.draw.rect (screen, healthbar, (1335, 25, -play2health, 25), 0)

    #player 2 shield bar
    pygame.draw.rect(screen, barout, (1340, 60, -70, 25), 0)
    pygame.draw.rect(screen, barback, (1335, 65, -60, 15), 0)
    if shield2 >= 1:
        pygame.draw.rect(screen, shieldbar, (1335, 65, -shield2, 15), 0)
